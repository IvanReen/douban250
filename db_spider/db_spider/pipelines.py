...
class MySqlPipeline(object):
    ...
    def process_item(self, item, spider):
        sql = 'insert into movie_list (img_url, movie_name, comment, movie_content, leading, imdb_url) values ("%s", "%s", "%s", "%s", "%s", "%s")' % (item["img_url"], item["movie_name"], item["comment"], item["movie_content"], item["leading"], item["imdb_url"])
